...
var modificarProducto = Vue.component('modificar-producto', {
    template: tempModificarProducto,
    data: function () {
        return {
            'sku': '',
            'categorias': null,
        ...
        modificar: function () {
            ...
            productoService.modificar(
                ...
                .then(function (data) {
                    ...
                    self.mensaje = "Producto modificado Correctamente"
